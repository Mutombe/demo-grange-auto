    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['WHERE CARS ', 'MEET', ' CHARACTER.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Grange Auto &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['SEDANS', 'SUVs', 'TRUCKS', 'LUXURY', 'IMPORTS', 'FLEET SALES'];
...
function ServicesGrid() {
  ...
  const serviceImages = ['https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800&q=80', 'https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=800&q=80', 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800&q=80', 'https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=800&q=80', 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800&q=80', 'https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=800&q=80'];
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Quality Inspected', desc: 'Every vehicle undergoes a comprehensive multi-point inspection before it reaches our lot.' },
    { title: 'Transparent Pricing', desc: 'No hidden fees, no negotiation games. The price you see is fair and final.' },
    { title: 'Flexible Financing', desc: 'We work with leading banks to offer terms that fit your budget comfortably.' },
    { title: 'After-Sales Support', desc: 'Our relationship does not end at the sale. Warranties, servicing, and support included.' }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">Grange</span>
            </h2>
